 ...
 * что тип класса указан как «любой класс, производный от Pet», так что newInstance() создает
 * Pet, не требуя приведения типа. Метод randomPet() осуществляет случайное индексирование
...
abstract class PetCreator {
    ...
    // любой класс, производный от Pet
