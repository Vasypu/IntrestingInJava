 ...
 *  Карты (Мар)
 *  <p>
 *  Реализация карты на основе хеш-таблицы (используйте вместо устаревшего класса Hashtable).
 *  Поиск и вставка пар занимает небольшое постоянное время. Производительность можно настроить, указав
 *  в конструкторах особые значения для емкости и коэффициента загрузки.
 *  <p>
