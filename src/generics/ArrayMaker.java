...
// массива) Array.newlnstance() не располагает информацией типа, подразумеваемой для kind;
// следовательно, метод не может выдать конкретный результат, и возникает необходимость в приведении
// типа с выдачей предупреждения. Метод Array.newlnstance() рекомендуется использовать для создания
