 ...
 *  Ограничения
 *  <p>
 *  Ограничения были кратко представлены ранее в этой главе. Они сужают диапазон параметров-типов, которые могут
 *  использоваться с обобщениями. И хотя это позволяет вам задавать свои правила относительно типов, к которым
 *  могут применяться обобщения, более важным может оказаться другой эффект: возможность вызова методов из
 *  ограниченных типов. Для установления этого ограничения обобщения Java используют ключевое слово extends.
 *  Важно понимать, что в контексте обобщений extends имеет совершенно иной смысл, чем обычно.
 */
