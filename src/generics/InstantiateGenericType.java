 ...
 *  <p>
 *  Попытка создания экземпляра new T() в Erased.java завершилась неудачей — отчасти из-за стирания,
 *  отчасти из-за того, что компилятор не может убедиться в наличии у T конструктора по умолчанию
 *  (без аргументов).
 */
