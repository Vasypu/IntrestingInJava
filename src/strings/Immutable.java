 ...
 * Постоянство строк
 * <p>
 * В методе implicit() в строке 35 каждый раз создается объект StringBuilder в байт-коде.
 * А в методе explicit() один раз создается объект StringBuilder, а в цикле идет добавление.
 * <p>
