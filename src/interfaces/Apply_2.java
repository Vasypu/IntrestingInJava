 ...
 * Для работы прошлого кода на участке №1 создадим абстрактный класс StringProcessor с реализацией
 ...
 * от реализации, появилась возможность использовать его с разными реализациями, а следовательно появилась
